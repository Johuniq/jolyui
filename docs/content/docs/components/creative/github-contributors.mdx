...
description: GitHub contributors avatar grid for React. Displays contributor avatars with tooltips showing stats. Perfect for open-source project landing pages.
preview: true
links:
