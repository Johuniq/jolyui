...
description: Animated GitHub star counter for React. Real-time API data, rolling numbers, and confetti effects. Showcase your open-source project's popularity.
preview: true
links:
