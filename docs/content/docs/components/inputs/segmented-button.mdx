...
description: iOS-style segmented control for React. Animated selection indicator with smooth spring transitions. Perfect for filters, tabs, and toggle groups.
preview: true
links:
