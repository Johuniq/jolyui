...
export function EarthMap() {
  ...
  if (!mounted) {
    return (
      <div
        className="flex min-h-screen w-full items-center justify-center overflow-x-hidden p-4"
  ...
  return (
    ...
    >
      <button
        onClick={toggleTheme}
        className="absolute top-4 right-4 rounded-lg border border-gray-300 bg-white p-2 text-gray-900 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-700"
