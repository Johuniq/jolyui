    ...
    <BentoGrid className="mx-auto max-w-7xl gap-4 p-4">
        ...
        <CardContent className="flex h-full flex-col justify-between p-8">
          <div className="relative z-10">
            ...
            <p className="max-w-md text-lg text-muted-foreground leading-relaxed">
              Protect your data with military-grade encryption, multi-factor authentication, and real-time threat detection.
            </p>
          </div>
          ...
          <div className="mt-8 flex items-center gap-6">
            <div className="flex -space-x-3">
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className="h-10 w-10 rounded-full border-2 border-background bg-muted ring-1 ring-primary/10" />
              ))}
            </div>
            <p className="text-sm font-medium text-muted-foreground">
              Trusted by <span className="text-foreground">500+</span> enterprises
            </p>
          </div>
        </CardContent>
        {/* Decorative background element */}
        <div className="absolute -bottom-12 -right-12 h-64 w-64 rounded-full bg-primary/5 blur-3xl transition-all group-hover:bg-primary/10" />
      </Card>
      ...
      <Card className="group border-border/50 bg-card/50 backdrop-blur-sm transition-all hover:border-amber-500/30">
        <CardContent className="p-6">
          ...
          <p className="text-sm text-muted-foreground">
            Experience sub-millisecond latency with our globally distributed edge network.
          </p>
          <div className="mt-6 flex items-center gap-2">
            <Badge variant="secondary" className="bg-amber-500/10 text-amber-600 dark:text-amber-400">99.9% Uptime</Badge>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="group border-border/50 bg-card/50 backdrop-blur-sm transition-all hover:border-blue-500/30">
        <CardContent className="p-6">
          ...
          <p className="text-sm text-muted-foreground">
            Deploy your applications to over 200+ locations worldwide with a single click.
          </p>
          <div className="mt-6 flex items-center gap-2">
            <Badge variant="secondary" className="bg-blue-500/10 text-blue-600 dark:text-blue-400">Edge Ready</Badge>
          </div>
        </CardContent>
      </Card>

      {/* Developer Experience */}
      <Card className="md:col-span-2 border-border/50 bg-card/50 backdrop-blur-sm transition-all hover:border-emerald-500/30">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
            <div className="flex-1">
              ...
              <p className="text-muted-foreground">
                Comprehensive API documentation, SDKs for every language, and a powerful CLI to streamline your workflow.
              </p>
            </div>
            <div className="flex-1 rounded-xl border bg-background/50 p-4 font-mono text-xs">
              ...
              <p className="text-muted-foreground mt-1">// Initialize the client</p>
              <p className="text-blue-500">const <span className="text-foreground">client</span> = <span className="text-purple-500">new</span> <span className="text-amber-500">JolyClient</span>();</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="group border-border/50 bg-card/50 backdrop-blur-sm transition-all hover:border-purple-500/30">
        <CardContent className="p-6">
          ...
          <p className="text-sm text-muted-foreground">
            Native support for FaceID, TouchID, and WebAuthn for seamless security.
          </p>
          <div className="mt-6">
