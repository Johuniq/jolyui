...
const data: UserData[] = [
  ...
  { id: "2", name: "Bob Smith", email: "bob@example.com", role: "Developer", status: "active", department: "Engineering" },
  { id: "3", name: "Carol White", email: "carol@example.com", role: "Designer", status: "pending", department: "Design" },
  { id: "4", name: "David Brown", email: "david@example.com", role: "Developer", status: "inactive", department: "Engineering" },
  { id: "5", name: "Emma Davis", email: "emma@example.com", role: "Manager", status: "active", department: "Management" },
];
