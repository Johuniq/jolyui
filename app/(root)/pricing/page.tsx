...
export default function PricingPage() {
  ...
  function copyEmailToClipboard() {
    navigator.clipboard.writeText("support@johuniq.tech");
    setHasCopied(true);
      ...
      <div className="relative">
              ...
              >
                <div className="flex-1 space-y-6">
                  ...
                  <div className="space-y-2">
                    {tier.features.highlights.map((feature, idx) => (
                      <motion.div
                        key={idx}
                        initial={{
                          opacity: 0,
                ...
                <div className="mt-8">
                  <Button
                    ...
                    variant={tier.price ? "ghost" : "outline"}
                    onClick={() => handlePricingClick(tier.cta.href)}
                  >
                    {tier.cta.text}
        ...
        >
          <p className="text-sm text-gray-900 dark:text-gray-100">
            ...
            <a
              href="mailto:support@johuniq.tech"
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          {!isPending && !state.success && !state.error && (
            <DialogHeader>
              <DialogTitle className="text-xl">Come say hi! 👋</DialogTitle>
